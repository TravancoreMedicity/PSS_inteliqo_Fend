...
import { getAllDeptList, getAllDeptSectList, getCommonsettingData } from 'src/views/CommonCode/CommonReactQueries';
                ...
                if (succes === 1 && value !== null) {
                    ...
                    getAllPunchmastData(postdata).then((punchmastdata) => {
                        ...
                        if (status === 1) {
                            ...
                            attendnaceCountCalculationFunc(employeeData, data, value, commonSettings).then(async (allData) => {
