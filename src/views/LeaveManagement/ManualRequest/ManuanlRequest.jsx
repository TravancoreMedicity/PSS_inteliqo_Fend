...
const ManuanlRequest = () => {
            ...
            if (success === 0 || success === 1) {
                ...
                if ((lastUpdateDate === lastDay_month) || (lastUpdateDate > lastDay_month)) {
                    ...
                    if (success === 1) {
                        ...
                        const result = await axioslogin.post("/manualRequest/CreateManualRequest", filterArray);
    ...
    useEffect(() => {
        const getManuladata = async () => {
            const result = await axioslogin.get('/manualRequest/getAllManualrequest');
